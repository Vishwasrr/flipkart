...
from config import XL_PATH, BEAUTY_LOCS
from expected_values import BEAUTY_SUB_MENUS  # pylint:disable=R0801
from library.web_utils import WebUtils
from library.file_library import ReadFile
web = WebUtils()
read = ReadFile()
element, keys = read.read_objects(XL_PATH, BEAUTY_LOCS)


class BeautySubMenu:
    """fetches beauty submenus"""  # pylint:disable=R0801
